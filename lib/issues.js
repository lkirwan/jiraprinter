...
Issues.prototype._formatJira = function (issue, callback) {
  callback(null, {
    ...
    description: _.get(issue, this.fieldOverrides.description, issue.fields.description),
    ...
    assignee: _.get(issue, this.fieldOverrides.assignee, issue.fields.assignee),
    // assigneeAvatorUrl: _.get(issue, this.fieldOverrides.assignee.avatorUrl, issue.fields.assignee.avatorUrls.24x24),
    parent: _.get(issue, this.fieldOverrides.parent, issue.fields.parent),
